<template>
    <div>
      <div class="itemContent">
          <div :class="['itemContent-box']" v-for="(item,index) in myCollectList" :key="index">
            <div class="box-pic">
      ...
      <div class="mobile-itemContent">
        <li class="mobile-itemContent-li" v-for="(item,index) in myCollectList" :key="index" @click="buyDetail(item)">
